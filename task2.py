# -*- coding: utf-8 -*-
"""
Created on Thu Jun 15 12:06:41 2023
...
df      = pd.read_csv('data_mall.csv',usecols=['Annual Income (k$)','Spending Score (1-100)'])
x_whole = np.array(df)
x       = np.array(df['Annual Income (k$)'])
y       = np.array(df['Spending Score (1-100)'])
  
paint(x, y, [],'Y','Spending Score (1-100)','Basic graph')
